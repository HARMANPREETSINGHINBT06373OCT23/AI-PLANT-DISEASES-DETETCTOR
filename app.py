...
# ====== Disclaimer Message ======
st.warning("⚠️ **Disclaimer:** This app is part of a learning project and is not a professional diagnostic tool. "
           "It may produce incorrect or misleading results. Please consult agricultural experts or trusted sources "
           "for accurate disease identification and treatment recommendations. We do not take responsibility for any "
